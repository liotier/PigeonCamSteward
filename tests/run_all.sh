...
# and shellcheck hygiene). Criteria 2, 3, 5, 7, 8, 11 genuinely need a real
# camera, a real systemd init, and/or a real YouTube channel and are not
# claimed as passing here - see tests/MANUAL_VERIFICATION.md.
